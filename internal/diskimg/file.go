...
func CreateRootDiskImage(bundle resource.Bundle, initRD, tmpFile bool) (*ImageFile, error) {
	rootFSPath := bundle.ContentPath
	if initRD {
		...
		if err := cpio.Create(initrdFile, rootFSPath, defaultPermBitsMask[runtime.GOOS]); err != nil {
